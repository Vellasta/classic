...
export const TalentsMM = PresetUtils.makePresetTalents('Marksmanship', SavedTalents.create({ talentsString: '550000012-0505212250123251-002' }));
...
export const DefaultConsumes = Consumes.create({
	...
	defaultPotion: Potions.PotionOfQuickness,
